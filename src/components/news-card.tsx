...
const NewsCard = ({ title, content, link, type }: Props) => {
    ...
    <section>
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-4">
                    <div onClick={handleShare} className="text-gray-500 hover:text-gray-300 cursor-pointer">
            ...
            <div onClick={() => router.push(link)} className="cursor-pointer mt-4 text-gray-500 font-bold text-sm">
